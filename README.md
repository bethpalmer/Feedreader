...
To write a series of tests using the Jasmine library to check functionality works correctly in a template RSS feed reader web-based application.


# How to run this application

To run this web based application locally:
...
# Initial Information and Brief Provided
